...
test('That employer account logo is uploaded successfully', function () {
    ...
    $response = $this->actingAs($user)->post("/v1/employer/profile/upload-logo", [
    ...
    Storage::assertExists("public/company-logos/{$employer->uuid}-company-logo.png");

...
test('That employer uploads profile picture successfully', function () {
    ...
    $response = $this->actingAs($user)->post('/v1/employer/profile/upload-profile-picture', [
    ...
    Storage::assertExists('public/profile-pictures/employer-user/test@example.com-profile-picture.jpeg');

    $user = $user->refresh();

    expect($user->profile_picture_url)->toBe('profile-pictures/employer-user/test@example.com-profile-picture.jpeg');
});

test('That employer uploads profile picture is changed successfully', function () {

    Employer::factory()->create();

    $user = EmployerUser::factory()->create();

    $user->update(['profile_picture_url' => 'profile-pictures/employer-user/test@example.com-profile-picture.jpeg']);
   ...
   expect($response['status'])->toBe('200');
    ...
    Storage::assertExists('public/profile-pictures/employer-user/test@example.com-profile-picture.png');

    expect(Storage::exists('public/profile-pictures/employer-user/test@example.com-profile-picture.jpeg'))->toBeFalse();

    $user = $user->refresh();

    expect($user->profile_picture_url)->toBe('profile-pictures/employer-user/test@example.com-profile-picture.png');
